...
SkillServerListItemTooltip::SkillServerListItemTooltip(QWidget *parent)
    : DWidget(parent)
{
    initUI();
    ...
    connect(m_pHideTimer, &QTimer::timeout, this, &SkillServerListItemTooltip::hide);
}

void SkillServerListItemTooltip::setContent(const QString &name, const QString &description)
{
    QString htmlContent;
...
void SkillServerListItemTooltip::hideTooltip(int delay)
{
    if (delay > 0) {
...
void SkillServerListItemTooltip::holdTooltip()
{
    m_pHideTimer->stop();
}

void SkillServerListItemTooltip::onAnchorClicked(const QUrl &url)
{
    QDesktopServices::openUrl(url);
    hideTooltip(0);
}

void SkillServerListItemTooltip::initUI()
{
    setFixedWidth(354);
    ...
    connect(m_pTextBrowser, &QTextBrowser::anchorClicked, this, &SkillServerListItemTooltip::onAnchorClicked);
