...
QMap<int, QString> WXQFCodeTranslation::errorMessages()
{
    static const QMap<int, QString> errorMessages = {
        ...
        {4,      QCoreApplication::translate("WXQFCodeTranslation", "There are currently too many visitors, please try again later.")},
        ...
        {18,     QCoreApplication::translate("WXQFCodeTranslation", "There are currently too many visitors, please try again later.")},
