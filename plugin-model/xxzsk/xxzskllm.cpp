...
XxzskLLM::XxzskLLM(QObject *parent)
    : QObject(parent)
    , LLMModel()
{
...
QString XxzskLLM::model() const
{
    return modelID();
}

QJsonObject XxzskLLM::generate(const QString &content, const QVariantHash &params, LLMModel::streamFuncion stream, void *user)
{
    QJsonObject sendObj;
    ...
    QUrl url("http://10.10.16.11:8502/xx/chat");
    ...
    QObject::connect(this, &XxzskLLM::sigAbort, reply, &QNetworkReply::abort);
    QObject::connect(this, &XxzskLLM::sigAbort, &loop, &QEventLoop::quit);
