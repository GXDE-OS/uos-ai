...
Απαντήστε στις ερωτήσεις των χρηστών, ενσωματώνοντας οποιαδήποτε σχετική κοινή γνώση. Αν δεν γνωρίζετε την απάντηση, απλώς πείτε το. Μην εφεύρετε πράγματα.
...
Βάσει του αιτήματος του χρήστη, δημιουργήστε περιεχόμενο υψηλής ποιότητας που ανταποκρίνεται στις συγκεκριμένες ανάγκες τους.


---Τύποι Γραφής---

1. Άρθρο: Γράψτε καλά δομημένα άρθρα με σαφή επιχειρήματα και ελκυστικό περιεχόμενο

2. Ομιλίες: Δημιουργήστε συναρπαστικές ομιλίες με σωστή εισαγωγή, κύριο μέρος και συμπέρασμα


3. Περιγράμματα: Δημιουργήστε ένα δομημένο περίγραμμα για το δοσμένο θέμα

4. Ειδοποιήσεις: Γράψτε επίσημες ειδοποιήσεις ή ανακοινώσεις

5. Δημοσιεύσεις: Δημιουργήστε ελκυστικό περιεχόμενο για κοινωνικά δίκτυα

6. Αναφορά Εργασίας: Γράψτε περιεκτικές αναφορές εργασίας

7. Ερευνητική Αναφορά: Δημιουργήστε λεπτομερείς ερευνητικές αναφορές
...
Παρακαλώ δώστε το περιεχόμενο στην ακόλουθη μορφή:
...
Βάσει του αιτήματος του χρήστη, δημιουργήστε ποιοτικό περιεχόμενο που καλύπτει τις συγκεκριμένες ανάγκες του.

---Τύποι Γραφής---
1. Άρθρο: Συντάξτε καλοδουλεμένα άρθρα με σαφή επιχειρήματα και ελκυστικό περιεχόμενο
2. Ομιλίες: Δημιουργήστε πειστικές ομιλίες με σωστή εισαγωγή, κυρίως μέρος και συμπεράσματα
3. Περιγράμματα: Σχεδιάστε δομημένο περίγραμμα για το δοσμένο θέμα
4. Ειδοποιήσεις: Συντάξτε επίσημες ανακοινώσεις ή ειδοποιήσεις
5. Αναρτήσεις: Δημιουργήστε ελκυστικό περιεχόμενο κοινωνικών μέσων
6. Έκθεση Εργασίας: Συντάξτε ολοκληρωμένες εκθέσεις εργασίας
7. Έκθεση Έρευνας: Δημιουργήστε λεπτομερείς εκθέσεις έρευνας
---Είσοδος---
%1

---Μορφή Εξόδου---
Παρακαλώ παρέχετε το περιεχόμενο στην ακόλουθη μορφή:
Τίτλος:
Περιεχόμενο:</translation>
    </message>
    <message>
...
Επεξεργαστείτε και βελτιώστε το εισερχόμενο κείμενο διατηρώντας το αρχικό του νόημα
και στυλ.


---Τύποι Επεξεργασίας---

1. Σύνοψη: Δημιουργήστε μια συνοπτική περίληψη των κύριων σημείων

2. Επιμέλεια: Αναγνωρίστε και διορθώστε γραμματικά, ορθογραφικά και στυλιστικά λάθη

3. Εξήγηση: Δώστε λεπτομερείς εξηγήσεις για πολύπλοκες έννοιες ή αποσπάσματα

4. Επέκταση: Αναπτύξτε βασικά σημεία διατηρώντας το αρχικό στυλ

5. Συνέχεια: Συνεχίστε το κείμενο με συνεκτικό και φυσικό τρόπο

6. Εξωραϊσμός: Βελτιώστε τη σαφήνεια, τη ροή και την επίδραση του κειμένου διατηρώντας
την ουσία του
...
Παρακαλώ δώστε το επεξεργασμένο κείμενο απευθείας χωρίς πρόσθετους
...
2. Να απαντάτε σε γλωσσικά ερωτήματα
3. Να εντοπίζετε και να διαχειρίζεστε συγκεκριμένα αιτήματα μετάφρασης

---Στόχος---
Αναλύστε προσεκτικά την είσοδο του χρήστη για να προσδιορίσετε την πρόθεσή του:
1. Αν η είσοδος περιέχει φράσεις όπως «τι σημαίνει αυτό», «εξήγησε αυτή τη φράση» ή παρόμοια – δώστε ΜΟΝΟ γλωσσική εξήγηση (όχι μετάφραση)
2. Αν η είσοδος καθορίζει συγκεκριμένη πρόταση/παράγραφο προς μετάφραση (π.χ. «Μετάφρασε αυτή την πρόταση:...») – μεταφράστε ΜΟΝΟ το καθορισμένο τμήμα (όχι πλήρη μετάφραση)
3. Μόνο όταν δεν εντοπιστεί συγκεκριμένο αίτημα, εκτελέστε πλήρη μετάφραση μεταξύ κινεζικών και αγγλικών

Διατηρείτε πάντα το αρχικό νόημα, τον τόνο και το ύφος. Για μεταφράσεις:
- Κινέζικα → Αγγλικά
- Αγγλικά → Κινέζικα

Για γλωσσικά ερωτήματα, δώστε σαφείς και σύντομες εξηγήσεις.

---Είσοδος---
%1

---Μορφή Εξόδου---
1. Για πλήρεις μεταφράσεις: Παρέχετε μόνο τη μετάφραση χωρίς επιπλέον μορφοποίηση
2. Για μερικές μεταφράσεις: Παρέχετε μόνο τη μετάφραση του καθορισμένου τμήματος
3. Για εξηγήσεις: Παρέχετε μόνο την εξήγηση στην ίδια γλώσσα με το ερώτημα
Ποτέ μη συνδυάζετε εξήγηση με μετάφραση ή παρέχετε πλήρη μετάφραση μετά από μερική μετάφραση</translation>
    </message>
</context>
<context>
    <name>EAiProxy</name>
...
<context>
    ...
    <message>
        ...
        <translation>Αποτυχία αποκωδικοποίησης ήχου</translation>
    </message>
    <message>
        <location filename="../src/audio/trans/iatcodetranslation.cpp" line="17"/>
        <source>Engine session ended</source>
        <translation>Η συνεδρία του κινητήρα έληξε</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Λείπουν απαιτούμενες παράμετροι ή οι παράμετροι είναι παράνομες</translation>
    </message>
    <message>
        <location filename="../src/audio/trans/iatcodetranslation.cpp" line="27"/>
        <source>Invalid handle</source>
        <translation>Μη έγκυρη λαβή</translation>
    </message>
    <message>
        <location filename="../src/audio/trans/iatcodetranslation.cpp" line="28"/>
        <source>Reading data timeout</source>
        <translation>Λήξη χρόνου ανάγνωσης δεδομένων</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Επανεκκίνηση αμέσως</translation>
    </message>
    <message>
...
Prompt Example: Name all files in the newly created folder on the desktop as project materials and arrange them in numerical order.</source>
        <translation>Σύστημα AI Έξυπνη Λειτουργία Μπάτλερ

Εισαγωγή: Προγραμματίζει έξυπνα τα εργαλεία του συστήματος για να εκτελούν πολύπλοκες λειτουργίες συστήματος, υποστηρίζοντας τον έλεγχο του συστήματος, τη διαχείριση αρχείων, τη διαχείριση εφαρμογών και πρωτόκολλα δικτύωσης.
...
<context>
    ...
    <message>
        ...
        <source>Daily flow control exceeds limit</source>
        <translation>Υπέρβαση ημερήσιου ορίου ροής</translation>
    </message>
    <message>
        <location filename="../src/audio/trans/ttscodetranslation.cpp" line="21"/>
        <source>The request data format is illegal</source>
        <translation>Μη έγκυρη μορφή δεδομένων αιτήματος</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <source>Required parameters are missing or the parameters are illegal</source>
        <translation>Λείπουν απαραίτητες παράμετροι ή οι παράμετροι είναι μη έγκυρες</translation>
    </message>
    <message>
        <location filename="../src/audio/trans/ttscodetranslation.cpp" line="24"/>
        <source>Reading data timeout</source>
        <translation>Λήξη χρονικού ορίου ανάγνωσης δεδομένων</translation>
    </message>
    <message>
        <location filename="../src/audio/trans/ttscodetranslation.cpp" line="25"/>
        <source>network anomaly</source>
        <translation>δικτυακή ανωμαλία</translation>
    </message>
    <message>
        <location filename="../src/audio/trans/ttscodetranslation.cpp" line="34"/>
        <source>Connection failed, please check the fill in information.</source>
        <translation>Αποτυχία σύνδεσης, παρακαλώ ελέγξτε τις πληροφορίες που συμπληρώσατε.</translation>
    </message>
</context>
<context>
...
• Polish {selection} into a recruitment copy within 100 words, highlighting teamwork.</source>
        <translation>Όσο πιο συγκεκριμένη είναι η εντολή, τόσο πιο ακριβές είναι το παραγόμενο περιεχόμενο. Για παράδειγμα:

• Δημιουργήστε μια περιγραφή PPT για {selection} με 3 κεφάλαια και 10 βασικά σημεία.
...
<context>
    ...
    <message>
        ...
        <translation>DDE Shell AI Γραμμή</translation>
    </message>
    <message>
        <location filename="../src/gui/mgmt/private/aibarwidget.cpp" line="52"/>
        <source>Drag files quickly</source>
        <translation>Σύρετε γρήγορα αρχεία</translation>
    </message>
    <message>
        <location filename="../src/gui/mgmt/private/aibarwidget.cpp" line="52"/>
        <source>Drag files to the AI ribbon for intelligent processing</source>
        <translation>Σύρετε αρχεία στη λωρίδα AI για έξυπνη επεξεργασία</translation>
    </message>
</context>
<context>
...
<context>
    ...
    <message>
        ...
        <translation>Εισαγωγή στο πεδίο εισαγωγής</translation>
    </message>
</context>
<context>
...
{&quot;subject&quot;: &quot;Θέμα&quot;, &quot;startTime&quot;: &quot;Ώρα έναρξης προγράμματος, μορφή: yyyy-MM-ddThh:mm:ss&quot;, &quot;endTime&quot;: &quot;Ώρα λήξης προγράμματος, μορφή: yyyy-MM-ddThh:mm:ss&quot;}

Εισαγωγή: %1

Τρέχουσα ώρα: %2</translation>
    </message>
</context>
<context>
...
<context>
    ...
    <message>
        ...
        <translation>Η συσκευή πρέπει να επανεκκινηθεί πριν μπορέσει να χρησιμοποιηθεί πλήρως αυτή η λειτουργία.</translation>
    </message>
</context>
<context>
...
<context>
    ...
    <message>
        ...
        <translation>Προφυλάξεις</translation>
    </message>
    <message>
        ...
        <translation>Το τοπικό μοντέλο DeepSeek έχει ορισμένες απαιτήσεις για τη διαμόρφωση του υπολογιστή. Εάν η διαμόρφωση είναι χαμηλότερη από την προτεινόμενη, η εμπειρία θα επηρεαστεί.</translation>
    </message>
    <message>
        <location filename="../src/gui/mgmt/private/deepseekmodelitem.cpp" line="54"/>
        <source>Recommended configuration</source>
        <translation>Προτεινόμενη διαμόρφωση</translation>
    </message>
    <message>
        ...
        <translation>&lt;b&gt;Προτεινόμενη Διαμόρφωση&lt;/b&gt;&lt;br&gt;&lt;b&gt;CPU: &lt;/b&gt;Υψηλής απόδοσης πολυπύρηνο CPU (όπως Intel i5/i7 ή AMD Ryzen 5/7 σειρά), με ταχύτητα ρολογιού πάνω από 3.0 GHz.&lt;br&gt;&lt;b&gt;GPU: &lt;/b&gt;Με βίντεο μνήμη πάνω από 4GB.&lt;br&gt;&lt;b&gt;Μνήμη: &lt;/b&gt;8GB και πάνω.&lt;br&gt;&lt;b&gt;Σκληρός Δίσκος: &lt;/b&gt;SSD με τουλάχιστον 5GB ελεύθερου χώρου.</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Απόκρυψη FollowAlong στις ακόλουθες εφαρμογές</translation>
    </message>
</context>
<context>
    ...
    <message>
        ...
        <translation>Ενεργοποίηση λειτουργιών διακομιστή MCP</translation>
    </message>
    <message>
        ...
        <translation>Μερικές λειτουργίες τρίτων διακομιστών MCP ενέχουν ορισμένους κινδύνους. Χρησιμοποιήστε τις με προσοχή. Εάν ενεργοποιήσετε αυτή την υπηρεσία, ένα ενσωματωμένο εργαλείο θα εντοπίσει και θα κατεβάσει αυτόματα τις απαραίτητες εξαρτήσεις. Η διαδικασία λήψης θα επιβαρύνει με χρεώσεις δεδομένων. Λάβετε υπόψη τους κινδύνους και προχωρήστε με προσοχή.</translation>
    </message>
    <message>
        ...
        <translation>Έχω κατανοήσει και συμφωνώ να χρησιμοποιήσω αυτή την υπηρεσία</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Ρωτήστε την ΤΝ</translation>
    </message>
</context>
<context>
    ...
    <message>
        ...
        <translation>Τι να ρωτήσετε γι&apos; αυτό;</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation type="unfinished">Απενεργοποίηση σε Αυτήν την Εφαρμογή</translation>
    </message>
    <message>
        <location filename="../src/wordwizard/wrapper/inputwindow.cpp" line="116"/>
        <source>Disable Globally</source>
        <translation type="unfinished">Απενεργοποίηση Παγκοσμίως</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Το πεδίο &apos;mcpServers&apos; λείπει.</translation>
    </message>
    <message>
        <location filename="../src/agent/mcpserver.cpp" line="76"/>
        <source>Remove old custom server config failed, server name: %0</source>
        <translation>Η αφαίρεση της παλιάς προσαρμοσμένης ρύθμισης διακομιστή απέτυχε, όνομα διακομιστή: %0</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Τα έγγραφα δεν υπάρχουν!</translation>
    </message>
</context>
<context>
...
{&quot;subject&quot;: &quot;Θέμα Email&quot;, &quot;content&quot;: &quot;Κύριο Μέρος Email&quot;, &quot;to&quot;: &quot;Παραλήπτης&quot;, &quot;cc&quot;: &quot;CC Παραλήπτης&quot;, &quot;bcc&quot;: &quot;BCC Παραλήπτης&quot;}

Εισαγωγή: %1</translation>
    </message>
</context>
<context>
...
<context>
    ...
    <message>
        ...
        <translation>Διαχείριση Δεξιοτήτων</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Οι πρώτες 4 δεξιότητες θα εμφανίζονται στη γραμμή εργαλείων, ενώ οι υπόλοιπες θα είναι κρυμμένες στο μενού &quot;Περισσότερα&quot;.</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Είστε βέβαιοι ότι θέλετε να διαγράψετε τη δεξιότητα &quot;%1&quot;;</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Το επιλεγμένο κείμενο έχει υπερβεί το όριο των 2000 χαρακτήρων.</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Αρχείο ενημερώσεων Βοηθού UOS AI</translation>
    </message>
</context>
<context>
...
<context>
    ...
    <message>
        ...
        <translation>Αυτόματη εμφάνιση της γραμμής εργαλείων UOS AI Ακολούθηση όταν επιλέγεται κείμενο.</translation>
    </message>
    <message>
        <location filename="../src/gui/mgmt/private/wordwizardwidget.cpp" line="89"/>
        <source>After closing, the selected text can still be woken up by the shortcut Super+R bar.</source>
        <translation>Μετά το κλείσιμο, το επιλεγμένο κείμενο μπορεί να ανακληθεί με τη συντόμευση Super+R.</translation>
    </message>
</context>
</TS>
